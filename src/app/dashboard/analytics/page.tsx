      ...
      {(githubAnalysis || leetcodeAnalysis) && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginBottom: 24 }} className="animate-in animate-delay-2">
            ...
            <div className="glass-card">
              <div className="glass-card-body">
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
                  <div style={{ width: 36, height: 36, borderRadius: "var(--radius-md)", background: "rgba(255,255,255,0.06)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                ...
                <div className="grid-cols-3" style={{ marginBottom: 16, gap: 10 }}>
                  <div style={{ padding: 10, borderRadius: "var(--radius-sm)", background: "rgba(255,255,255,0.03)" }}>
          ...
          <div className="glass-card">
            <div className="glass-card-body">
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
                <div style={{ width: 36, height: 36, borderRadius: "var(--radius-md)", background: "rgba(255,255,255,0.06)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.1rem" }}>
                  🧩
                </div>
              ...
              {!leetcodeAnalysis ? (
                ...
                <>
                  ...
                  <div className="grid-cols-4" style={{ marginBottom: 16, gap: 8 }}>
                    <div style={{ padding: 10, borderRadius: "var(--radius-sm)", background: "rgba(255,255,255,0.03)", textAlign: "center" }}>
